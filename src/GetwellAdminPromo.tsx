/* =========================================================================
   ...
   Story:  PROBLEM → WORKFLOW → BUILD → FEATURES → OUTCOME
...
export const T = {
  problemIn: 0,
  painIn: 180,
  /** The drop. Music impact, hard cut to the application. */
  reveal: 360,
  windowIn: 420,
  dashboard: 480,
  patients: 630,
...
export const CHAPTERS = [
  ...
  { label: "The solution", from: T.reveal, to: T.dashboard },
  { label: "Inside Getwell", from: T.dashboard, to: T.fanOut },
  { label: "Getwell Admin", from: T.fanOut, to: T.end },
];
...
/** Camera state interpolated over the whole application walkthrough. */
export type Cam = {
  x: number;
  y: number;
  scale: number;
...
/* -------------------------------------------------------------------------
   ...
   One window lives for the whole application walkthrough. The camera moves around it and
  ...
  return (
    <AbsoluteFill style={{ opacity: actOut, fontFamily: FONT }}>
      ...
      <AbsoluteFill style={{ zIndex: 70 }}>
          ...
          >
            ...
            <Kinetic
              words={[
                ...
                { t: "details" },
                { t: "across" },
                { t: "different", accent: true },
                { t: "places.", accent: true },
              ]}
              frame={frame}
              fps={fps}
              start={92}
        ...
        <Stamp frame={frame} fps={fps} at={180} text="Too many places." />
        <Stamp frame={frame} fps={fps} at={240} text="Too many steps." />
        <Stamp frame={frame} fps={fps} at={300} text="Too much to keep track of." accent />
      </AbsoluteFill>
    </AbsoluteFill>
  );
};
...
/* -------------------------------------------------------------------------
   ACT TWO — the application. One window, five pages, one continuous camera move.
   ------------------------------------------------------------------------- */
...
const CAPTIONS: Caption[] = [
  {
    ...
    eyebrow: "Dashboard",
    words: [
      { t: "I" }, { t: "started" }, { t: "with" }, { t: "one" },
      { t: "clear", accent: true }, { t: "overview.", accent: true },
    ],
    pos: "top",
  },
  {
    ...
    eyebrow: "Patients",
    words: [
      { t: "I" }, { t: "created" }, { t: "a" }, { t: "central" },
      { t: "patient", accent: true }, { t: "list." },
    ],
    pos: "left",
  },
  {
    ...
    words: [
      { t: "I" }, { t: "structured" }, { t: "each" }, { t: "profile" },
      { t: "around", accent: true }, { t: "key" }, { t: "information." },
    ],
    pos: "right",
  },
  {
    ...
    words: [
      { t: "I" }, { t: "added" }, { t: "tracking" }, { t: "for" },
      { t: "visits," }, { t: "missed", accent: true }, { t: "visits," }, { t: "and" }, { t: "follow-ups." },
    ],
    pos: "left",
  },
  {
    ...
    eyebrow: "Reports",
    words: [
      { t: "I" }, { t: "included" }, { t: "reports" }, { t: "for" },
      { t: "revenue", accent: true }, { t: "and" }, { t: "panel" }, { t: "claims." },
    ],
    pos: "top",
  },
];
    ...
    <AbsoluteFill style={{ opacity: actIn * actOut, fontFamily: FONT }}>
      ...
      {frame < 448 ? (
        ...
        >
          ...
          <Kinetic
            words={[{ t: "So" }, { t: "I" }, { t: "built" }, { t: "Getwell" }, { t: "Admin.", accent: true }]}
            frame={frame}
            fps={fps}
            start={T.reveal + 12}
            per={4}
          ...
          >
            I wanted one workflow, shaped around how the team actually works.
          </div>
        </div>
      ) : null}
        ...
        <>
          ...
          >
            ...
            <Kinetic
              words={[
                { t: "I" }, { t: "built" }, { t: "the" },
                { t: "system", accent: true }, { t: "around" }, { t: "the" }, { t: "workflow.", accent: true },
              ]}
              frame={frame}
              fps={fps}
              start={T.fanOut + 14}
          ...
          >
            {["Organise.", "Track.", "Review.", "Follow up."].map((w, i) => {
    ...
    <AbsoluteFill style={{ opacity: inP, fontFamily: FONT }}>
      ...
      <AbsoluteFill style={{ alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center", transform: `scale(${settle})` }}>
          ...
          >
            A workflow I designed from a real operational problem.
          </div>
          ...
          >
            From scattered details to one connected workflow.
          </div>
